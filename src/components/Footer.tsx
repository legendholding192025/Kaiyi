    ...
    <footer className="text-white relative" style={{ backgroundColor: '#222222' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
                         <h3 className="text-lg font-semibold mb-4">{t('footer.lineup')}</h3>
          ...
          {/* After Sales */}
          <div>
                         <h3 className="text-lg font-semibold mb-4">{t('footer.afterSales')}</h3>
            <ul className="space-y-2 text-gray-300">
              <li>
