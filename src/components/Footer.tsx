...
export default function Footer() {
  ...
  return (
    <footer className="text-white relative" style={{ backgroundColor: '#222222' }}>
      {/* Top Horizontal Line */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">Check out the line up:</h3>
      ...
      <div className="text-center py-6">
        <p className="text-gray-400 text-sm">
          Privacy Policy | All right reserved by legend holding group
        </p>
      </div>
      
      {/* Floating Phone Button - Original Position (left side) */}
      <div className="fixed bottom-6 left-6 z-50">
        <button className="w-16 h-16 bg-gray-700 rounded-full flex items-center justify-center hover:bg-gray-600 transition-colors shadow-lg">
